...
import { MenuItem, MenuItemSelectAvatar, MenuItemMultiSelectAvatar } from 'twenty-ui/navigation';
import { ComponentDecorator, RecoilRootDecorator } from 'twenty-ui/testing';
...
export const DropdownInsideModal: Story = {
  decorators: [I18nFrontDecorator, RecoilRootDecorator, ComponentDecorator],
  parameters: {
