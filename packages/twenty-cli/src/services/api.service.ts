...
export class ApiService {
  ...
  async upsertAsset({
    ...
    try {
      const mutation = `
        mutation UpsertAsset($applicationId: String!, $assetHash: String!, $assetContent: String!) {
          upsertAsset(applicationId: $applicationId, assetHash: $assetHash, assetContent: $assetContent)
        }
      `;
